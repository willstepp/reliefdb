...
rsync_args="-arvuz $script_dir/../ prod@monomyth.io:/home/prod/public/reliefdb.monomyth.io --exclude-from $script_dir/exclude.txt"
site_dir="reliefdb.monomyth.io"
...
echo "\033[0m"
ssh $deploy_env@monomyth.io "bash -l -c 'cd ./public/$site_dir;pwd;which bundle;bundle install --without development --path vendor/bundle'"
res=$?
[ $res -ne 0 ] && echo "\033[0;31m" && echo $error_output && echo "\033[0m" && exit 1
